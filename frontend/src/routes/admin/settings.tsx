...
function SettingsPage() {
  ...
  const { profile, profileLoading: fetching, profileError, updateProfile } = useApp()
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (form.newPassword) {
          debugLog.warn(t('admin_password_update_not_yet_implemented_via_profile_en'), {
        ...
        debugLog.error(
          ...
          { service: 'admin-settings', operation: 'handleSubmit', userId: profile.id },
          error
        )
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card className="border-2">
          <CardHeader>
            ...
            <CardDescription>{t('common_current_account_details')}</CardDescription>
          </CardHeader>
            ...
            <div className="space-y-1">
              ...
              <p className="text-base font-semibold">
                {userInfo.name !== t('common_unavailable') ? (
                  ...
                  <span className="text-muted-foreground italic">{userInfo.name}</span>
                )}
              </p>
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <p className="text-base font-semibold">
                {userInfo.phone !== t('common_unavailable') ? (
                  ...
                  <span className="text-muted-foreground italic">{userInfo.phone}</span>
                )}
              </p>
            </div>
            <div className="space-y-1">
              ...
              <p className="text-base font-semibold">
                {userInfo.address !== t('common_unavailable') ? (
                  ...
                  <span className="text-muted-foreground italic">{userInfo.address}</span>
                )}
              </p>
            </div>
            <div className="space-y-1 pt-2 border-t">
              ...
              <p className="text-base font-semibold">
                {userInfo.role !== t('common_unavailable') ? (
                  ...
                  <span className="text-muted-foreground italic">{userInfo.role}</span>
                )}
              </p>
            </div>
          </CardContent>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="email">{t('account_profile_email_address')}</Label>
                  <Input
                    id="email"
                    name="email"
                    value={form.email}
              ...
              <div className="space-y-4 pt-4 border-t">
                <h3 className="text-lg font-semibold">{t('common_change_password')}</h3>
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="currentPassword">{t('common_current_password')}</Label>
                    <Input
                      id="currentPassword"
                      ...
                      onChange={handleChange}
                      placeholder={t('admin_settings_placeholder_current_password')}
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      <Label htmlFor="newPassword">{t('common_new_password')}</Label>
                      <Input
                        id="newPassword"
                        name="newPassword"
                        type="password"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="confirmPassword">{t('common_confirm_new_password')}</Label>
                      <Input
                        id="confirmPassword"
                        ...
                        onChange={handleChange}
                        placeholder={t('admin_settings_placeholder_confirm_password')}
                        autoComplete="new-password"
                        className="h-11"
                      />
                    </div>
