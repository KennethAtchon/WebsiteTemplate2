          ...
          <CardContent className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="flex items-center gap-3 rounded-lg border bg-muted/30 p-4">
                ...
                <div>
                  <p className="font-semibold text-sm">{t('payment_ssl_encrypted')}</p>
                  <p className="text-xs text-muted-foreground">{t('payment_bank_level_security')}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 rounded-lg border bg-muted/30 p-4">
                ...
                <div>
                  <p className="font-semibold text-sm">{t('payment_secure_processing_badge')}</p>
                  <p className="text-xs text-muted-foreground">{t('payment_pci_compliant')}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2 rounded-lg border bg-primary/5 p-4">
              <p className="text-sm font-semibold">{t('payment_your_payment_is_secure')}</p>
