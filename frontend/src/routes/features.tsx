    ...
    <PageLayout variant="public">
      ...
      <Section>
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">{t('features_calculator_types')}</h2>
      ...
      <Section variant="muted" padding="default">
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">{t('common_platform_features')}</h2>
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">{t('features_platform_description')}</p>
        </div>
              ...
              <Card key={index} className="border-2 hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="space-y-2 pt-4 border-t">
                    <div className="text-xs font-semibold text-muted-foreground uppercase">{t('features_available_in')}</div>
                    <div className="space-y-1">
                      <div className="text-sm"><span className="font-medium">{t('subscription_basic')}:</span> {feature.tiers.basic}</div>
                      <div className="text-sm"><span className="font-medium">{t('subscription_pro')}:</span> {feature.tiers.pro}</div>
                      <div className="text-sm"><span className="font-medium">{t('subscription_enterprise')}:</span> {feature.tiers.enterprise}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <Section>
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold tracking-tight md:text-4xl">{t('features_perfect_for')}</h2>
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">{t('features_perfect_for_description')}</p>
        </div>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Section variant="gradient" maxWidth="2xl">
        <div className="text-center">
          ...
          <p className="mb-8 text-lg text-muted-foreground">{t('features_ready_description')}</p>
