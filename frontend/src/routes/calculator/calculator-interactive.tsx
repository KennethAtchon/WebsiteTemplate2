    ...
    return (
      <Card className="mx-auto max-w-md border-2">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">{t('calculator_access_required')}</CardTitle>
          <CardDescription>
            {t('common_please_sign_in_to_access_our_professional_calculator_suite')}
          </CardDescription>
        </CardHeader>
  ...
  return (
    <>
      ...
      {usageLimitReached && role && (
        <div className="mb-6">
          <ErrorAlert error={t('calculator_reached_limit')} className="border-2" />
      ...
      <Card className="border-2">
        <CardContent className="p-6">
          <Tabs
            ...
            onValueChange={(value) => setSelectedCalculator(value as CalculationType)}
            className="space-y-6"
          >
