  ...
  return (
    <PageLayout variant="public">
      <HeroSection
        ...
        description={t('common_your_privacy_is_important_to_us_learn_how_we_protect_and_han')}
        showGradient
      >
      ...
      <Section maxWidth="4xl">
        <Card className="border-2 shadow-lg">
          <CardContent className="p-8 md:p-12 space-y-8">
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('privacy_introduction')}</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('common_information_we_collect')}</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('common_how_we_use_your_information')}</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t('common_your_information_is_used_to_provide_and_improve_our_services')}
              </p>
            </section>

            <section>
              <h2 className="text-3xl font-bold mb-4">{t('privacy_data_security')}</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('privacy_your_rights')}</h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                {t('common_you_have_the_right_to_access_correct_or_delete_your_personal')}
              </p>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
