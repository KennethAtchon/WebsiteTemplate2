  ...
  return (
    <PageLayout variant="public">
      <HeroSection
        ...
        description={t('common_please_read_these_terms_carefully_before_using_our_services')}
        showGradient
      >
      ...
      <Section maxWidth="4xl">
        <Card className="border-2 shadow-lg">
          <CardContent className="p-8 md:p-12 space-y-8">
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('common_acceptance_of_terms')}</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('common_use_of_services')}</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t('common_you_agree_to_use_our_services_only_for_lawful_purposes_and_i')}
              </p>
            </section>

            <section>
              <h2 className="text-3xl font-bold mb-4">{t('common_user_accounts')}</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('terms_subscription')}</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('common_intellectual_property')}</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t('common_all_content_and_materials_provided_through_calcpro_services_')}
              </p>
            </section>

            <section>
              <h2 className="text-3xl font-bold mb-4">{t('common_limitation_of_liability')}</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('contact_metadata_title')}</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
