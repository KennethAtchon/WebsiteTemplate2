      ...
      <Section maxWidth="4xl">
        <Card className="border-2 shadow-lg">
          <CardContent className="p-8 md:p-12 space-y-8">
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('cookies_what_are_title')}</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6">{t('cookies_types_title')}</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('cookies_control_title')}</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-4">{t('cookies_changes_title')}</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
