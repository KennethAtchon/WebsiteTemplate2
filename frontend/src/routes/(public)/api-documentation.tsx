...
function ApiDocumentationPage() {
  ...
  const endpointGroups: EndpointGroup[] = [
    {
      ...
      endpoints: [
        { method: 'GET', path: t('api_endpoint_types'), description: t('api_endpoint_types_desc') },
        { method: 'POST', path: t('api_endpoint_calculate'), description: t('api_endpoint_calculate_desc') },
        { method: 'GET', path: t('api_endpoint_history'), description: t('api_endpoint_history_desc') },
        { method: 'POST', path: t('api_endpoint_export'), description: t('api_endpoint_export_desc') },
        { method: 'GET', path: t('api_endpoint_usage'), description: t('api_endpoint_usage_desc') },
      ],
    },
    {
    ...
    },
    {
      ...
      endpoints: [
        { method: 'GET', path: t('api_endpoint_profile'), description: t('api_endpoint_profile_desc') },
        { method: 'DELETE', path: t('api_endpoint_delete'), description: t('api_endpoint_delete_desc') },
      ],
    },
    {
      title: t('api_gdpr_title'),
      endpoints: [
        { method: 'GET', path: t('api_endpoint_export_data'), description: t('api_endpoint_export_data_desc') },
        { method: 'POST', path: t('api_endpoint_object'), description: t('api_endpoint_object_desc') },
      ],
    },
  ]
  ...
  const errorCodes = [t('api_error_401'), t('api_error_403'), t('api_error_429'), t('api_error_500')]
    ...
    <PageLayout variant="public">
      ...
      <Section maxWidth="4xl">
        <div className="space-y-8">
              ...
              <CardContent>
                <div className="divide-y">
                  {group.endpoints.map((ep) => (
                    <div key={ep.path} className="py-4 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-start gap-3">
                      <Badge
          ...
          <Card className="border-2 shadow-lg">
            <CardHeader>
              <CardTitle className="text-2xl">{t('api_error_codes_title')}</CardTitle>
            </CardHeader>
            <CardContent>
