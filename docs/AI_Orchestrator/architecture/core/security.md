...
**Location:** `shared/services/csrf/csrf-protection.ts`
...
**Location:** `shared/services/rate-limit/comprehensive-rate-limiter.ts`, `shared/constants/rate-limit.config.ts`
...
**Location:** `shared/utils/security/pii-sanitization.ts`
