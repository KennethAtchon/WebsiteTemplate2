...
async function postHandler(request: NextRequest) {
  try {
    ...
    debugLog.info(
      "Form completion metric received",
      {
        service: "analytics",
    ...
    debugLog.error(
      "Error processing form completion data",
      {
        service: "analytics",
        operation: "form-completion",
      },
...
import { formCompletionSchema } from "@/shared/utils/validation/api-validation";

export const POST = withPublicProtection(postHandler, {
  bodySchema: formCompletionSchema,
