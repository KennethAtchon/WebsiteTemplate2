/**
 * Payment Page - Modern SaaS Design
 *
 * Main payment processing page with modern SaaS styling.
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createPageMetadata({
    title: t("calculator_mortgage_amortization_payment"),
    description: t("metadata_payment_description"),
    path: "/payment",
  }).metadata;
}
