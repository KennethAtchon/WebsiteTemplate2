/**
 * Calculator Interactive Component - Client Component
 *
 * Handles interactive parts of calculator page: calculator selection, usage stats, and calculator components
 */
...
export function CalculatorInteractive() {
  ...
  return (
    <>
      ...
      {/* Usage Limit Alert - Only show if user has subscription AND limit reached */}
