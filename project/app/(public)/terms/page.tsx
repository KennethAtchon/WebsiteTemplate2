/**
 * Terms of Service Page - Modern SaaS Design
 *
 * Terms of service page with modern SaaS styling.
 */
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createPageMetadata({
    title: t("metadata_terms_title"),
    description: t("terms_metadata_description"),
    path: "/terms",
  }).metadata;
}
