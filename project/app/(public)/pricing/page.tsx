...
import { PricingInteractive } from "./pricing-interactive";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createPageMetadata({
    title: t("metadata_pricing_title"),
    description: t("pricing_metadata_description"),
    path: "/pricing",
  }).metadata;
}
          ...
          <CardContent className="p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="text-lg px-8 h-12 shadow-lg">
                <Link
                  href={`/checkout?tier=${SUBSCRIPTION_TIERS.PRO}&billing=monthly`}
                >
