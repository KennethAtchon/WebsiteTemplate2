 ...
 *
 * Comprehensive overview of calculator features, capabilities, and use cases.
 */
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createPageMetadata({
    title: t("metadata_features_title"),
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline" size="lg" className="saas-button">
              <Link href="/sign-up">{t("home_hero_cta_start_trial")}</Link>
            </Button>
          </div>
        </div>
      </Section>
