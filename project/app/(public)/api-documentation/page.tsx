 ...
 *
 * Documents all public-facing API endpoints for CalcPro.
 */
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createPageMetadata({
    title: t("metadata_api_documentation_title"),
    description: t("metadata_api_documentation_description"),
          ...
          <Card className="border-2 shadow-lg">
            <CardHeader>
              <CardTitle className="text-2xl flex items-center gap-2">
                ...
                {t("api_authentication_title")}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                {t("api_authentication_text")}
              </p>
              <code className="block rounded-lg bg-muted px-4 py-3 text-sm font-mono text-foreground">
                {t("api_authentication_example")}
              </code>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 shadow-lg">
            <CardHeader>
              <CardTitle className="text-2xl flex items-center gap-2">
                ...
                {t("api_rate_limiting_title")}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                {t("api_rate_limiting_text")}
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 shadow-lg">
            <CardHeader>
              <CardTitle className="text-2xl flex items-center gap-2">
                ...
                {t("api_responses_title")}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                {t("api_responses_text")}
              </p>
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <p className="mb-2 text-sm font-semibold">Success</p>
                  <code className="block rounded-lg bg-muted px-4 py-3 text-xs font-mono text-foreground whitespace-pre">{`{ "data": { ... } }`}</code>
                </div>
                <div>
                  <p className="mb-2 text-sm font-semibold">Error</p>
                  <code className="block rounded-lg bg-muted px-4 py-3 text-xs font-mono text-foreground whitespace-pre">{`{ "error": "...", "details": "..." }`}</code>
                </div>
              </div>
            </CardContent>
          </Card>
