/**
 * Privacy Policy Page - Modern SaaS Design
 *
 * Privacy policy page with modern SaaS styling.
 */
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createPageMetadata({
    title: t("metadata_privacy_title"),
    description: t("privacy_metadata_description"),
    path: "/privacy",
  }).metadata;
}
