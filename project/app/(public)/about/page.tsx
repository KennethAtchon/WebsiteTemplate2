/**
 * About Page - Modern SaaS Design
 *
 * Company mission, team information, and calculator expertise.
 */
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return createPageMetadata({
    title: t("about_metadata_title"),
    description: t("about_metadata_description"),
    path: "/about",
  }).metadata;
}
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline" size="lg" className="saas-button">
              <Link href="/contact">{t("contact_metadata_title")}</Link>
            </Button>
          </div>
        </div>
      </Section>
